<div class="container mx-auto py-16 px-8 sm:px-10 lg:px-20 bg-gradient-to-r from-blue-50 to-indigo-100 min-h-screen">
    ...
    @if (count($questions) > 0)
        <div class="mt-12 flex justify-center">
            <button wire:click="downloadCsv" class="bg-blue-600 text-white px-12 py-4 rounded-full shadow-lg hover:bg-blue-700 focus:ring-4 focus:ring-blue-400 transition-transform transform hover:scale-105">
                Download CSV
            </button>
        </div>
    @endif
